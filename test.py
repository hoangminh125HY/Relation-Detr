...
def test_on_dataset():
    ...
    dataset = CocoDetection(
        img_folder=f"/kaggle/input/mode-heavy-rain-dts/Moderate_heavy_rain/test/img",
        ann_file=f"/kaggle/input/mode-heavy-rain-dts/Moderate_heavy_rain/test/anno/_annotations.coco 14.41.56.json",
    ...
    if args.model_config is None or args.show_dir and accelerator.is_main_process:
        coco_dt = loadRes(COCO(f"/kaggle/input/mode-heavy-rain-dts/Moderate_heavy_rain/test/anno/_annotations.coco 14.41.56.json"), args.result)
