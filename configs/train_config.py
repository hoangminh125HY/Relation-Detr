...
coco_path = "/kaggle/input/mode-heavy-rain-dts/Moderate_heavy_rain"  # /PATH/TO/YOUR/COCODIR
train_dataset = CocoDetection(
    img_folder=f"/kaggle/input/mode-heavy-rain-dts/Moderate_heavy_rain/train/img",
    ann_file=f"/kaggle/input/mode-heavy-rain-dts/Moderate_heavy_rain/train/anno/_annotations.coco.json",
    transforms=presets.detr,  # see transforms/presets to choose a transform
        train=True,
    )
test_dataset = CocoDetection(
    img_folder=f"/kaggle/input/mode-heavy-rain-dts/Moderate_heavy_rain/valid/img",
    ann_file=f"/kaggle/input/mode-heavy-rain-dts/Moderate_heavy_rain/valid/anno/_annotations.coco 14.42.30.json",
    transforms=None,  # the eval_transform is integrated in the model
)

# model config to train
model_path = "/kaggle/working/Relation-Detr/configs/relation_detr/relation_detr_resnet50_800_1333.py"
